...
def main():
    ...
    train_dataset = "/home/wso2123/My  Work/Datasets/Webscope/A4Benchmark/A4Benchmark_full.csv"
    validate_dataset = "/home/wso2123/My  Work/Datasets/Webscope/A4Benchmark/validate.csv"
    # test_dataset = "/home/wso2123/My  Work/Datasets/Webscope/A4Benchmark/test.csv"
    one_class_dataset = "/home/wso2123/My  Work/Datasets/Webscope/A4Benchmark/train.csv"
...
def model_build(i):
    ...
    anomaly_model = H2OAutoEncoderEstimator(
        ...
        l1=1e-4,
        epochs=10,
        ignored_columns=[train_data.names[2]],
    )
    ...
    for j in range(r1,r2+1):
        name = "/home/wso2123/My  Work/Datasets/Webscope/A4Benchmark/A4Benchmark-TS"+str(j)+".csv"
        print name
        test_data = h2o.import_file(name)
