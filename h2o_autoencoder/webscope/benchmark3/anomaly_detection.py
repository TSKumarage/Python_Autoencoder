...
def main():
    ...
    train_dataset = "/home/wso2123/My  Work/Datasets/Webscope/A3Benchmark/A3Benchmark_full.csv"
    validate_dataset = "/home/wso2123/My  Work/Datasets/Webscope/A3Benchmark/validate.csv"
    # test_dataset = "/home/wso2123/My  Work/Datasets/Webscope/A3Benchmark/test.csv"
...
def model_build(i):
    ...
    anomaly_model = H2OAutoEncoderEstimator(
        ...
        l1=1e-4,
        epochs=10,
        ignored_columns=[train_data.names[2], train_data.names[1]],
    )
    ...
    for j in range(r1,r2+1):
        name = "/home/wso2123/My  Work/Datasets/Webscope/A3Benchmark/A3Benchmark-TS"+str(j)+".csv"
        print name
